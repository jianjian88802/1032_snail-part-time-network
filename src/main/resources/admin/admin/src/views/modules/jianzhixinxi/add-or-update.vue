          ...
          <el-form-item class="input" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="职位简介" prop="zhiweijianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="职位简介"
                  v-model="ruleForm.zhiweijianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhiweijianjie" label="职位简介" prop="zhiweijianjie">
                    <span>{{ruleForm.zhiweijianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
