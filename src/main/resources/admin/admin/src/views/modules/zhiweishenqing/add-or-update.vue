          ...
          <el-form-item class="input" label="薪资待遇" prop="xinzidaiyu">
              <el-input v-model="ruleForm.xinzidaiyu" 
                placeholder="薪资待遇" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="职位简介" prop="zhiweijianjie">
          <el-input v-model="ruleForm.zhiweijianjie" 
              placeholder="职位简介" clearable  :readonly="ro.zhiweijianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="职位简介" prop="zhiweijianjie">
              <el-input v-model="ruleForm.zhiweijianjie" 
                placeholder="职位简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作内容" prop="gongzuoneirong">
          <el-input v-model="ruleForm.gongzuoneirong" 
              placeholder="工作内容" clearable  :readonly="ro.gongzuoneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作内容" prop="gongzuoneirong">
              <el-input v-model="ruleForm.gongzuoneirong" 
                placeholder="工作内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinzidaiyu = true;
            continue;
	            	            ...
	            	            if(o=='zhiweijianjie'){
            this.ruleForm.zhiweijianjie = obj[o];
	    this.ro.zhiweijianjie = true;
            continue;
          }
	            	            if(o=='gongzuoneirong'){
