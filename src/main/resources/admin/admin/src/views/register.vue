  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(106, 0, 138, 0.47);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 247, 247, 1);fontSize:28px;">蜗牛兼职网注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="企业号" class="input" v-if="tableName=='qiye'">
			  <el-input v-model="ruleForm.qiyehao" autocomplete="off" placeholder="企业号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='qiye'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='qiye'">
